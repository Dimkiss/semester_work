...
spaCy демонстрирует умеренную точность, но низкую полноту: модель часто пропускает сущности, особенно в сложных спортивных таблицах. Русская модель для spaCy имеет всего три сущности['LOC', 'ORG', 'PER'], так что её точность оставляет желать лучшего.
